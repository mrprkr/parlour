...
If the first model fires too easily or not at all, the
...
rather than pushing the threshold much past 0.7, which mostly stops it
hearing you as well. The other settings are in [Tuning](/docs/tuning).
