...
`parlour service restart` picks it up. `parlour doctor` confirms it, or names
the file it cannot find. Keep `hey_jarvis` in the list for the first day. It
...
stays silent, check its inputs first:
